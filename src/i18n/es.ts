...
export const es: Record<string, string> = {
  ...
  "I actively use AI tools (Figma Make, Lovable, Claude) to accelerate discovery, prototyping, and validation, while staying close to how emerging technologies are shaping the future of product experiences.":
    "Utilizo de forma activa herramientas de IA (Figma Make, Lovable, Claude) para acelerar el proceso de descubrimiento, creación de prototipos y validación, sin perder de vista cómo las tecnologías emergentes están dando forma al futuro de las experiencias de producto.",
